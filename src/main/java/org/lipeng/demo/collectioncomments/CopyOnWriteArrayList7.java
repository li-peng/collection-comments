 ...
 * {@code CopyOnWriteArrayList7}
 * <a href="package-summary.html#MemoryVisibility"><i>happen-before</i></a>
 * actions subsequent to the access or removal of that element from
 * the {@code CopyOnWriteArrayList7} in another thread.
 *
 ...
 */
public class CopyOnWriteArrayList7<E>
     ...
     */
    public CopyOnWriteArrayList7(Collection<? extends E> c) {
     ...
     */
    public CopyOnWriteArrayList7(E[] toCopyIn) {
    ...
    public Object clone() {
        try {
            CopyOnWriteArrayList7 c = (CopyOnWriteArrayList7)(super.clone());
            c.resetLock();
            return c;
    ...
    /**
     * Sublist for CopyOnWriteArrayList7.
    ...
    {
        private final CopyOnWriteArrayList7<E> l;
        private final int offset;
        private int size;
        private Object[] expectedArray;

        // only call this holding l's lock
        COWSubList(CopyOnWriteArrayList7<E> list,
    ...
    static {
        try {
            ...
            Class k = CopyOnWriteArrayList7.class;
